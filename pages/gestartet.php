...
<body>
  ...
  <div id="dateiKarte" class="text-center">
    ...
    <div class="text-center">
      Deutsch (Sprache1)
      <h1>Leben (Abgefragtes Wort)</h1>
    </div>

    <form>
      <div class="mb-3">
        <label for="Vokabel" class="form-label">English (Sprache2)</label>
        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
      </div>

      <button type="submit" class="btn btn-warning">Previous</button>
  ...
  <div class="fixed-bottom buttonBar">
    <div class="text-end">
      <a href="auswertung.html" class="btn btn-outline-dark btn-warning">Auswerten</a>
    </div>
  </div>


  <!--<img class="w-70" src="https://cdn-images.otto-office.com/oode/b2b/deu/mediadatacat/art/1200/OODE_ART_67/OODE_ART_67729GB_00.jpg" alt="gelbe Karteikarte">-->
